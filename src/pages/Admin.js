...
export default function Admin() {
  ...
  const mockInquiries = [
    { id: 1, name: "Harish Kumar", company: "EkathaCabs Cochin", email: "director@ekathacabs.com", budget: "$1,499 USD", status: "Closed", date: "May 29, 2026", msg: "Refactoring and mobile responsiveness optimization for Kochi cab fleets." },
    { id: 2, name: "Sneha Nair", company: "Home2Home Real Estate", email: "sneha@home2home.com", budget: "$2,999 USD", status: "Contacted", date: "May 28, 2026", msg: "Luxury property search UI grid containing Figma styles." },
